...
public class UserTestCase {
	 ...
	 * user.setRole("USER"); // user.setEnabled(true); user.setPassword("123456");
	 * 
	 ...
	 * 
	 * address.setUserId(user.getId()); assertEquals("Failed to add the user!",
